<table>
  <tr>
    <td><img src="./images/AirBar.png" alt="AirBar Logo" width="64" height="64"></td>
    <td><h1>AirBar</h1></td>
  </tr>
</table>
...
![AirGradient Dashboard](./images/airgradient-dashboard.png)
...
2. **Configure the App**:  
   ...
   ![Configuration Screen](./images/configure.png)
